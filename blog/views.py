...
def home(request):
    ...
    paypal_dict_02 = {
        ...
        "currency_code": "CAD",
        "item_name": "standard",
        "invoice": request.user + "-standard-" + User.objects.get(username=request.user).profile.invoice_count,
        "notify_url": "https://mywickeddjangoapp.herokuapp.com/paypal/",
        "return": "https://mywickeddjangoapp.herokuapp.com/paypal-return/",
        "cancel_return": "https://mywickeddjangoapp.herokuapp.com/paypal-cancel/",
        "custom": "premium_plan",  # Custom command to correlate to some function later (optional)
    ...
    paypal_dict_03 = {
        ...
        "currency_code": "CAD",
        "item_name": "unlimited",
        "invoice": request.user + "-unlimited-" + User.objects.get(username=request.user).profile.invoice_count,
        "notify_url": "https://mywickeddjangoapp.herokuapp.com/paypal/",
        "return": "https://mywickeddjangoapp.herokuapp.com/paypal-return/",
        "cancel_return": "https://mywickeddjangoapp.herokuapp.com/paypal-cancel/",
        "custom": "premium_plan",  # Custom command to correlate to some function later (optional)
